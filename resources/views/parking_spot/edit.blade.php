<x-app-layout>
    <x-parking-spot-form action="{{ route('parking_spot.confirm') }}" :capacity="$capacity"
        ...
        :rate-day-types="$rateDayTypes" :rate-unit-minutes="$rateUnitMinutes" :max-rate-periods="$maxRatePeriods" :rates-input="$ratesInput" :business-hour-day-types="$businessHourDayTypes" :business-hours-input="$businessHoursInput" />
